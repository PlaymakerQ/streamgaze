...
def main():
    ...
    merge_dataset, merge_base_path = get_merge_config(args.dataset)
    ...
    return results, merge_dataset, merge_base_path
...
if __name__ == "__main__":
    ...
    if main_result is None:
        ...
        results, merge_dataset, merge_base_path = main_result
    ...
    if results is not None:
        ...
        if results:
            ...
            if successful > 0:
                ...
                print(f"{'='*60}")
                merge_all_metadata(merge_dataset, merge_base_path)
        else:
